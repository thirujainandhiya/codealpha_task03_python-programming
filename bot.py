...
pairs = [
    [
        ...
        ["Hello! What is your name? How can I assist you?",]
    ],
    [
        r"my name is (.*)",
    ...
    [
        r"(.*)I need info|information about chatbot working state?",
        ["Thank you for asking.", "I'm just a chatbot. I don't have feelings but I'm here to help. I will provide all kind information and help you identify all types of info about that question.",]
    ],
    [
        r"How can I call you|your name?",
